...
\begin{enumerate}
    ...
    \item Use MeshJS or the Cardano CLI to submit listing and purchase transactions to the contract address, attaching the inline datum and redeemer as shown in the MeshJS section below.
