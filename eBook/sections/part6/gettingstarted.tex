...
Note that this script requires an environment variable named \texttt{BLOCKFROST\_PROJECT\_ID} to be set to your Blockfrost project id. You can define a new environment variable in your terminal by running (in the same session you're also executing the script!):
