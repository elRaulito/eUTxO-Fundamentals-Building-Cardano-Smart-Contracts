...
\begin{itemize}
  ...
  \item \textbf{MeshJS library}: Mesh (\texttt{@meshsdk/core}) is the actively maintained off-chain library for Cardano. It replaces older libraries such as Lucid, which is no longer maintained, and we'll use it throughout this book for building, signing and submitting transactions.
...
\begin{itemize}
  ...
  \item \textbf{api.signTx}: Signing a tx that was built with Mesh or any other library we sign and interact with the blockchain
\end{itemize}
